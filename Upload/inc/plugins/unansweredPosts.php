...
function unansweredPosts_info()
{
    ...
    return Array(
        ...
        'website' => 'https://github.com/lukasamd/MyBB-View_Unanswered_Posts',
        'author' => 'Lukasz Tkacz & edits for 1.8.x usage by Vintagedaddyo',
...
class unansweredPosts
{
    ...
    public function modifyOutput(&$content)
    {
        ...
        // Hide link Hide if 1 & 0
        if ($this->getConfig('StatusCounterHide') == 1 && $numThreads == 0)
        {
            return false;
        }

        // Hide link Show if 1 & not 0
        if ($this->getConfig('StatusCounterHide') == 1 && $numThreads !== 0) {
