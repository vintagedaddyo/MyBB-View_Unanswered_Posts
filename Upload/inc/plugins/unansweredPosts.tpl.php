...
({$numThreads})'),
    ...
    public static function activate()
    {
        ...
        find_replace_templatesets('header_welcomeblock_member_search', '#' . preg_quote('{$lang->welcome_todaysposts}</a>') . '#', '{$lang->welcome_todaysposts}</a><!-- UNANSWEREDPOSTS_LINK -->');
    }
    ...
    public static function deactivate()
    {
        ...
        find_replace_templatesets('header_welcomeblock_member_search', '#' . preg_quote('<!-- UNANSWEREDPOSTS_LINK -->') . '#', '');
    }
